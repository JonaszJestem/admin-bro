...
const RecordInList = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_designSystem.TableRow, {
    ...
    key: "options"
  }, recordActions.length ? /*#__PURE__*/_react.default.createElement(_designSystem.DropDown, {
    stick: "right"
  }, /*#__PURE__*/_react.default.createElement(_designSystem.DropDownTrigger, null, /*#__PURE__*/_react.default.createElement(_designSystem.Button, {
    variant: "text",
    size: "icon",
    ...
    color: "grey100"
  }))), /*#__PURE__*/_react.default.createElement(_designSystem.DropDownMenu, {
    minWidth: "200px"
  }, recordActions.map(action => /*#__PURE__*/_react.default.createElement(_actionButton.default, {
    key: action.name,
    action: action,
    resourceId: resource.id,
    recordId: record.id,
    actionPerformed: handleActionPerformed
  }, /*#__PURE__*/_react.default.createElement(_designSystem.DropDownItem, null, /*#__PURE__*/_react.default.createElement(_designSystem.Icon, {
    icon: action.icon
  }), action.label))))) : ''));
};
