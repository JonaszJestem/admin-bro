...
const NoRecordsOriginal = props => {
  ...
  }, /*#__PURE__*/_react.default.createElement(_designSystem.Text, null, translateMessage('noRecordsInResource', resource.id)), canCreate ? /*#__PURE__*/_react.default.createElement(_actionButton.default, {
    action: canCreate,
